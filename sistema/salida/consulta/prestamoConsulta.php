		...
		<div class="container col-lg-9 col-md-9 col-sm-9 col-sm-12">
	        <div class="row" name="principal">
	            ...
	            <?php
					...
					echo '	<form class="form-inline text-center" action="prestamoReporte.php" method="post">
					...
					$seleccion = "SELECT animal.idAnimal, animal.arete, animal.tipo, salida.tipoSalida, salida.fInicio, salida.fFinal, salida.precio FROM salida INNER JOIN animal ON salida.idAnimal = animal.idAnimal WHERE tipoSalida = 'prestamo' ";
