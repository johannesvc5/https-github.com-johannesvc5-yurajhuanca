<?php
	include 'plantilla_alpacas.php';
	require '../../conexion.php';
	
	$query = "SELECT * FROM animal LEFT OUTER JOIN salida ON salida.idAnimal = animal.idAnimal WHERE salida.idSalida IS NULL AND animal.tipo ='alpaca'";
