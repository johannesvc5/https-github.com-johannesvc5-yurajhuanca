                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h2 class="modal-title text-center" id="exampleModalLabe2">Editar Registro de Alpacas</h2>
                        </div>
                        <div class="modal-body">
                            <form class="formulario" action="alpacaEdit.php" method="post">
