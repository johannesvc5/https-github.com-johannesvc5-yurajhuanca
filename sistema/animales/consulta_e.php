...
if(isset($_POST['cliente_e']))
{
	$q=$db->real_escape_string($_POST['cliente_e']);
	$query="SELECT * FROM animal WHERE 
		animal.arete LIKE '%".$q."%'";
}
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h2 class="modal-title text-center" id="exampleModalLabe2">Editar Registro de Vacunos</h2>
                        </div>
                        <div class="modal-body">
                            <form class="formulario" action="vacunoEdit.php" method="post">
