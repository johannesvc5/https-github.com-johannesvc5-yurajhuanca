<?php
	...
	$query = "SELECT animal.idAnimal, animal.arete, animal.tipo, salida.tipoSalida, salida.fInicio, salida.fFinal, salida.precio FROM salida INNER JOIN animal ON salida.idAnimal = animal.idAnimal WHERE tipoSalida = 'prestamo' AND fInicio >= '$fecha_a' AND fInicio <= '$fecha_b' AND tipo = '$tipoAnimal'";
	...
	$pdf->Cell(190,6,'PRESTAMO DE '.strtoupper($tipoAnimal).'',1,1,'C',1);
